...
Зарегистрироваться через стандартный Signup frontend-приложения, после конслольной командой ./yii admin/add $id сделать нового пользователя администратором
# Тестовое задание
